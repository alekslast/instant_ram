...
import 'package:instant_ram/widgets/post/post_feed/post_constants.dart';
import 'package:instant_ram/widgets/post/post_feed/post_content.dart';
import 'package:instant_ram/widgets/post/post_feed/post_controls.dart';
import 'package:instant_ram/widgets/post/post_feed/post_footer.dart';
import 'package:instant_ram/widgets/post/post_feed/post_helpers.dart';
import 'package:instant_ram/widgets/post/post_feed/post_video_controller.dart';
...
class _PostWidgetState extends State<PostWidget> {
  late final bool _isVideo = PostHelpers.isVideo(widget.post.type);
  ...
  void initState() {
    ...
    if (_isVideo) {
      _videoController = PostVideoController(
        ...
        onInitialized: _onVideoInitialize,
  ...
  void _onVideoInitialize() => setState(() {});
  ...
  Widget build(BuildContext context) {
    final Widget dateWidget = PostHelpers.buildDateWidget(
